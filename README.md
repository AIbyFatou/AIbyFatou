...
I'm a **QA Engineer** specializing in test automation and AI reliability for B2B products.  
My background combines **4 years in quality & compliance** (Pro BTP, Europ Assistance) with **hands-on engineering** (Believe, Ada Tech School).

I don't just write tests — I build the **reliability layer** that makes AI systems trustworthy in production.
